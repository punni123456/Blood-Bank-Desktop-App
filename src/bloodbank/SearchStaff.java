...
public class SearchStaff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(300, 180, 700, 360);

        comboBoxSelection.setFont(new java.awt.Font("Trebuchet MS", 1, 18)); // NOI18N
        comboBoxSelection.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Staff ID", "Staff Name" }));
        jPanel1.add(comboBoxSelection);
        comboBoxSelection.setBounds(350, 110, 130, 40);
        ...
        textFieldSearch.setBounds(560, 110, 260, 50);
        ...
        jButton1.setBounds(30, 40, 160, 50);

        jLabel2.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Search Staff Details");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(330, 10, 420, 50);
        jPanel1.add(jSeparator1);
        jSeparator1.setBounds(260, 50, 540, 30);
    ...
    private void textFieldSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textFieldSearchKeyReleased
        ...
        con = DriverManager.getConnection(url);
            ...
            query="select * from Staff where staff_ID= "+textFieldSearch.getText();
            }
           if(comboBoxSelection.getSelectedIndex()==1){
           query="select * from Staff where staff_Name LIKE '%"+textFieldSearch.getText()+"%'";
            }
